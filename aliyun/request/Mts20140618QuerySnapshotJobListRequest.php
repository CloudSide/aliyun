<?php
/**
 * TOP API: mts.aliyuncs.com.QuerySnapshotJobList.2014-06-18 request
 * 
 * @author auto create
 * @since 1.0, 2015.09.22
 */
class Mts20140618QuerySnapshotJobListRequest
{
	/** 
	 * 截图作业Id列表，逗号隔开
	 **/
	...
	public function setSnapshotJobIds($snapshotJobIds)
	{
		...
		$this->apiParas["SnapshotJobIds"] = $snapshotJobIds;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->snapshotJobIds,"snapshotJobIds");
	}
