...
class Rds20140815ModifyDBInstanceSpecRequest
{
	...
	/** 
	 * 自定义存储空间，取值范围：mysql为[5,2000],sqlserver为[10,2000].此参数替代型号中的最大存储空间，见实例规格附表单位：GB只能升级
	 **/
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxValue($this->dBInstanceStorage,2000,"dBInstanceStorage");
