<?php
/**
 * TOP API: ecs.aliyuncs.com.ResetInstance.2013-01-10 request
 * 
 * @author auto create
 * @since 1.0, 2015.11.20
 */
class Ecs20130110ResetInstanceRequest
{
	/** 
	 * 进行重置操作的磁盘类型，取值为：system | data，默认值为system
	 **/
	private $diskType;
	
	/** 
	 * 重置系统时使用的镜像ID。仅在DiskType参数值为system时有效
	 **/
	private $imageId;
