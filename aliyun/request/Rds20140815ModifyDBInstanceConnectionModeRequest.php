<?php
/**
 * TOP API: rds.aliyuncs.com.ModifyDBInstanceConnectionMode.2014-08-15 request
 * 
 * @author auto create
 * @since 1.0, 2015.08.04
 */
class Rds20140815ModifyDBInstanceConnectionModeRequest
{
	/** 
	 * Performance为RLB或者RGW链路Safty为HAProxy链路
	 **/
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->connectionMode,"connectionMode");
