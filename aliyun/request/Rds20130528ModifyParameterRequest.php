<?php
/**
 * TOP API: rds.aliyuncs.com.ModifyParameter.2013-05-28 request
 * 
 * @author auto create
 * @since 1.0, 2014.10.14
 */
class Rds20130528ModifyParameterRequest
{
	/** 
	 * 实例名
	 **/
	...
	/** 
	 * 参数及其值的JSON串，参数的值都是字符串类型，如：{"auto_increment_increment":"1","character_set_client":"utf8"}
	 **/
	private $parameters;
