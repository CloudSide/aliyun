<?php
/**
 * TOP API: rds.aliyuncs.com.DescribeSQLLogRecords.2013-05-28 request
 * 
 * @author auto create
 * @since 1.0, 2014.10.14
 */
class Rds20130528DescribeSQLLogRecordsRequest
{
	/** 
	 * 实例名
	 **/
	...
	/** 
	 * 查询结束时间，格式如：yyyy-MM-dd'T’HH:mm:ssZ
	 **/
	private $endTime;
	...
	/** 
	 * 关键字查询，多个关键字以空格分隔，不超过10个关键字，不支持单引号'及双引号"
	 **/
	...
	public function setQueryKeyword($queryKeyword)
	{
		...
		$this->apiParas["QueryKeyword"] = $queryKeyword;
	}
