<?php
/**
 * TOP API: rds.aliyuncs.com.DescribeOperationLogs.2014-08-15 request
 * 
 * @author auto create
 * @since 1.0, 2015.06.02
 */
class Rds20140815DescribeOperationLogsRequest
{
	/** 
	 * 实例名称
	 **/
	...
	public function setdBInstanceUseType($dBInstanceUseType)
	{
		...
		$this->apiParas["DBInstanceUseType"] = $dBInstanceUseType;
	}
