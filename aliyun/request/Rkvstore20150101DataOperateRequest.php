<?php
/**
 * TOP API: r-kvstore.aliyuncs.com.DataOperate.2015-01-01 request
 * 
 * @author auto create
 * @since 1.0, 2015.03.10
 */
class Rkvstore20150101DataOperateRequest
{
	/** 
	 * 数据访问命令
	 **/
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->command,"command");
