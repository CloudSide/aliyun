<?php
/**
 * TOP API: dns.aliyuncs.com.SetDNSSLBStatus.2015-01-09 request
 * 
 * @author auto create
 * @since 1.0, 2015.11.16
 */
class Dns20150109SetDNSSLBStatusRequest
{
	/** 
	 * true=开启，false=关闭，默认为true
	 **/
	private $open;
	
	/** 
	 * 需要负载均衡的子域名 aliyun.com同@.aliyun.com；强制@
	 **/
	private $subDomain;
