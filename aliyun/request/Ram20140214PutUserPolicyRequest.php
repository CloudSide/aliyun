<?php
/**
 * TOP API: ram.aliyuncs.com.PutUserPolicy.2014-02-14 request
 * 
 * @author auto create
 * @since 1.0, 2015.01.27
 */
class Ram20140214PutUserPolicyRequest
{
	/** 
	 * input data
	 **/
	...
	public function setPolicyDocument($policyDocument)
	{
		...
		$this->apiParas["PolicyDocument"] = $policyDocument;
	}
	...
	public function setPolicyName($policyName)
	{
		...
		$this->apiParas["PolicyName"] = $policyName;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->policyDocument,"policyDocument");
		RequestCheckUtil::checkMaxLength($this->policyDocument,131072,"policyDocument");
		RequestCheckUtil::checkNotNull($this->policyName,"policyName");
		RequestCheckUtil::checkMaxLength($this->policyName,128,"policyName");
