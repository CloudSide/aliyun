<?php
/**
 * TOP API: rds.aliyuncs.com.DescribeParameterTemplates.2013-05-28 request
 * 
 * @author auto create
 * @since 1.0, 2014.10.14
 */
class Rds20130528DescribeParameterTemplatesRequest
{
	/** 
	 * 支持MySQL或SQLServer
	 **/
	...
	/** 
	 * 数据库的版本号，MySQL取值为：5.1或5.5，SQLServer的为：2008r2
	 **/
