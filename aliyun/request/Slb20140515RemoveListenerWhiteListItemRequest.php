<?php
/**
 * TOP API: slb.aliyuncs.com.RemoveListenerWhiteListItem.2014-05-15 request
 * 
 * @author auto create
 * @since 1.0, 2015.01.23
 */
class Slb20140515RemoveListenerWhiteListItemRequest
{
	/** 
	 * SLB实例前端使用的端口。
取值：1-65535
	...
	public function setSourceItems($sourceItems)
	{
		...
		$this->apiParas["SourceItems"] = $sourceItems;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->sourceItems,"sourceItems");
	}
