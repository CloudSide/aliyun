 ...
 * 
 * @author auto create
 * @since 1.0, 2015.02.11
 */
class Ecs20140526DescribeInstancesRequest
{
	/** 
	 * 实例内网ip地址（classic），最多不超过10个，实例网络类型（InstanceNetworkType）为classic时生效，否则忽略。
	 **/
	...
	/** 
	 * 实例私网ip地址（vpc），最多不超过10个，实例网络类型（InstanceNetworkType）为vpc时生效，否则忽略。
	 **/
	...
	public function setInnerIpAddresses($innerIpAddresses)
	{
		...
		$this->apiParas["InnerIpAddresses"] = $innerIpAddresses;
	}
	...
	public function setPublicIpAddresses($publicIpAddresses)
	{
		...
		$this->apiParas["PublicIpAddresses"] = $publicIpAddresses;
	}
