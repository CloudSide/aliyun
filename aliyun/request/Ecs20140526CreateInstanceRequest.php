...
具体参见附录：如何保证幂等性。
	...
	/** 
	 * 云服务器所属于的集群。且ClusterId必须属于ZoneId
	 **/
	private $clusterId;
...
默认值：none
	...
	public function setClusterId($clusterId)
	{
		...
		$this->apiParas["ClusterId"] = $clusterId;
	}
	...
	public function setInnerIpAddress($innerIpAddress)
	{
		...
		$this->apiParas["InnerIpAddress"] = $innerIpAddress;
	}
	...
	public function setIoOptimized($ioOptimized)
	{
		...
		$this->apiParas["IoOptimized"] = $ioOptimized;
	}
	...
	public function setNodeControllerId($nodeControllerId)
	{
		...
		$this->apiParas["NodeControllerId"] = $nodeControllerId;
	}
