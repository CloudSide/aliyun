<?php
/**
 * TOP API: slb.aliyuncs.com.SetListenerAccessControlStatus.2014-05-15 request
 * 
 * @author auto create
 * @since 1.0, 2015.01.23
 */
class Slb20140515SetListenerAccessControlStatusRequest
{
	/** 
	 * 是否开启访问控制
	 **/
...
取值：1-65535
	...
	public function setAccessControlStatus($accessControlStatus)
	{
		...
		$this->apiParas["AccessControlStatus"] = $accessControlStatus;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->accessControlStatus,"accessControlStatus");
