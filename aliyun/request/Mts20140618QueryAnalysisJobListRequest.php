<?php
/**
 * TOP API: mts.aliyuncs.com.QueryAnalysisJobList.2014-06-18 request
 * 
 * @author auto create
 * @since 1.0, 2015.07.30
 */
class Mts20140618QueryAnalysisJobListRequest
{
	/** 
	 * 智能分析作业Id列表，逗号隔开
	 **/
	...
	public function setAnalysisJobIds($analysisJobIds)
	{
		...
		$this->apiParas["AnalysisJobIds"] = $analysisJobIds;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->analysisJobIds,"analysisJobIds");
	}
