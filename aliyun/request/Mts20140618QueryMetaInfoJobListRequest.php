<?php
/**
 * TOP API: mts.aliyuncs.com.QueryMetaInfoJobList.2014-06-18 request
 * 
 * @author auto create
 * @since 1.0, 2015.05.29
 */
class Mts20140618QueryMetaInfoJobListRequest
{
	/** 
	 * 元信息分析作业Id列表，逗号隔开
	 **/
	...
	public function setMetaInfoJobIds($metaInfoJobIds)
	{
		...
		$this->apiParas["MetaInfoJobIds"] = $metaInfoJobIds;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->metaInfoJobIds,"metaInfoJobIds");
	}
