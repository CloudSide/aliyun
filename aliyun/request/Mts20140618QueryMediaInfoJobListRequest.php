<?php
/**
 * TOP API: mts.aliyuncs.com.QueryMediaInfoJobList.2014-06-18 request
 * 
 * @author auto create
 * @since 1.0, 2015.09.22
 */
class Mts20140618QueryMediaInfoJobListRequest
{
	/** 
	 * 元信息分析作业Id列表，逗号隔开
	 **/
	...
	public function setMediaInfoJobIds($mediaInfoJobIds)
	{
		...
		$this->apiParas["MediaInfoJobIds"] = $mediaInfoJobIds;
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->mediaInfoJobIds,"mediaInfoJobIds");
	}
